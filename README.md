...
- [Reverse String](arrays-strings/02-reverse-string.md)
...
- [Move Zeroes](basic-algorithms/07-move-zeroes.md)

### Stacks
- [Valid Parentheses](stacks/08-valid-parentheses.md)

### Linked Lists
- Reverse Linked List is the bonus problem and is not included in the required 8.
